...
export const dictionary = {
  en: {
    ...
    submitRequest: {
      ...
      quickSearchLabel: "SEARCH PUBLIC AUTHORITY",
      ...
      publicAuthLabel: "PUBLIC AUTHORITY",
      ...
      fullNameLabel: "FULL NAME (AS PER ADHAR CARD)",
      ...
      postalAddressLabel: "POSTAL ADDRESS FOR DISPATCH OF INFORMATION",
      ...
      bplYes: "Yes — BPL Fee Exempted (₹0.00 under RTI Rules)",
      ...
      rtiTextTitle: "TEXT FOR RTI APPLICATION",
      rtiTextLabel: "TEXT FOR RTI APPLICATION",
      rtiTextPlaceholder: "Type your request text here",
